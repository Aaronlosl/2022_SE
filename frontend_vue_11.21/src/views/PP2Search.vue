...
<template>
  <div class="home">
    ...
    <h2>
      <p>
        <t style="margin-right: 95px">Acadamy & Institution</t><br>
        <el-cascader :options="options" :props="{ checkStrictly: true }" style="width: 260px; top: 5px" clearable>
        </el-cascader>
      </p>
      <p>
        <t style="margin-right: 180px">Acadamy</t><br>
    ...
    <router-link to='/PP2Search/PP2Result'>
      <img src="@/assets/箭头一.svg" style="margin-left:220px">
    </router-link>
